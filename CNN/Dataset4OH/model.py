...
# Load CSV file
df = pd.read_csv('/home/tanvir/ML_Exam/CNN/Dataset4OH/url_spam_classification.csv', encoding='ISO-8859-1', low_memory=False)
df = df.rename(columns={"url": "text", "is_spam": "label"})
